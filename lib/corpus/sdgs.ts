...
export const MODULE_SDGS: Record<string, number[]> = {
  ...
  living_portfolio:     [4, 8, 10],
  ai_coach:             [8, 10, 4],
  fair_pay:             [8, 10, 5],
  life_chapter_designer:[8, 4, 10],
  talent_matching:      [8, 10, 5],
  talent_reengagement:  [8, 10, 17],
  retention_signals:    [8, 10],
  onboarding_predictor: [8, 4],
  workforce_resilience: [8, 9, 10],
  outcome_loop:         [4, 8],
  live_internship_marketplace: [4, 8, 17],
  curriculum_engine:    [4, 9, 8],
  readiness_profile:    [4, 10, 8],
  lifelong_learning_wallet: [4, 8, 10],
  feedback:             [17],
  security:             [10, 17],
  analytics:            [17],
  job_listings:         [8, 4, 10],
