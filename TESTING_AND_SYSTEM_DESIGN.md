...
1. `npm.cmd run lint`, `npm.cmd run test`, `npm.cmd run typecheck`, `npm.cmd run test:openapi`, `npm.cmd run build`, `npm.cmd run test:smoke`, `npm.cmd run test:a11y`, and `npm.cmd audit --json` pass.
